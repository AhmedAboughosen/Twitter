...
{
    public class TweetListener : IHostedService
    {
            ...
            IConfiguration configuration)
        {
            ...
            _exchangeName = configuration["MessageBroker:TweetExchangeName"];
        }
        ...
        private Task<bool> HandelSubject(object subject, BasicDeliverEventArgs message)
        {
            ...
            {
                (EventTypes.TweetAdded) => HandleAsync<TweetAddedData>(message),
